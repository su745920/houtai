      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        ...
        <div class="layui-form-item">
            <div style="display:flex;align-items: center">
                <label class="layadmin-user-login-icon layui-icon layui-icon-auz" for="LAY-user-login-password"></label>
                <input type="text" name="google_auth_code" lay-verify="required" placeholder="谷歌验证码" class="layui-input" />
            </div>
        </div>
