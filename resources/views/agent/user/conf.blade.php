    ...
    <div class="larry-personal-body clearfix">
        <form class="layui-form col-lg-5">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="address" autocomplete="off" class="layui-input" value="{{ $results['address'] }}" placeholder="" >
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <option value="0">资金账户余额</option>
                       <option value="10">资金冻结余额</option>

                        <option value="1" class="layui-disabled">币币余额</option>
                        <option value="11" class="layui-disabled">币币冻结余额</option>

                        <option value="2">合约余额</option>
                        <option value="12">合约冻结余额</option>



                        <option value="3">秒合约余额</option>
                        <option value="13">秒合约冻结余额</option>

                        <option value="4">理财余额</option>
                        <option value="14">理财冻结余额</option>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="info" placeholder="请输入内容" class="layui-textarea layui-disabled" readonly>系统调额</textarea>
                </div>
            </div>
