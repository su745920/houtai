...
<script type="text/html" id="fact_profits">
    ...
    @{{# if (d.profit_result == 1) { }}
        <span style="color: #1aab65; font-weight: bolder;">+@{{Number(d.fact_profits).toFixed(0)}}</span>
    @{{# } else { }}
        <span  style="color:#FF0000; font-weight: bolder;">-@{{Number(d.fact_profits).toFixed(0)}}</span>
    @{{# } }}
    </div>
</script>
    ...
    window.onload = function() {
        ...
        layui.use(['element', 'form', 'layer', 'table', 'laydate'], function() {
            ...
            var data_table =   table.render({
                elem: '#order_list',
                url: "/agent/user/micro_order_list?user_id="+user_id,
