    ...
    <div class="layui-tab">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <input type="hidden" name="agent_note_id" class="layui-input" value="{{$result->agent_note_id}}">
            </div>
...
<script>
    layui.use(['element', 'form', 'laydate', 'upload','table'], function() {
        ...
        form.on('submit(demo1)', function(data) {
         ...
         //监听工具条
            table.on('tool(addresslist)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'edit'){ //编辑
                    layer_show('编辑钱包地址',"{{url('agent/user/edit_address')}}?id="+data.id);
                }
            })
        ...
        tbRend("{{url('/agent/user/address_list')}}");
