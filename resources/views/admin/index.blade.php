...
<div class="layui-layout layui-layout-admin kit-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right kit-nav">
            ...
            <li class="layui-nav-item">
                <a href="javascript:;">
                    <img src="http://m.zhengjinfan.cn/images/0.jpg" class="layui-nav-img"> {{$admin->username}}
                </a>
                <!-- <dl class="layui-nav-child">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                ...
                <li class="layui-nav-item ">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/seller/logs', icon:'&#xe658;', title: '商家账户流水', id:'118'}">
                                <i class="layui-icon">&#xe658;</i>
                                <span>账户流水</span>
                            </a>
                        </dd>
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/legal_deal', icon:'&#xe658;', title: '法币交易', id:'19'}">
                                <i class="layui-icon">&#xe658;</i>
                                <span>法币交易</span>
                            </a>
                        </dd>
                ...
                <li class="layui-nav-item ">
                    <a href="javascript:;"><i class="fa fa-plug" aria-hidden="true"></i><span> 秒合约交易</span></a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/micro_order',icon:'&#xe658;', title: '秒合约交易',id:'88'}">
                                <i class="layui-icon">&#xe658;</i>
                                <span>秒合约交易</span>
                            </a>
                        </dd>
                ...
                <li class="layui-nav-item ">
                    ...
                    <!--<dl class="layui-nav-child">-->
                    <!--    <dd><a href="javascript:;" kit-target data-options="{url:'/admin/wallet/index', icon:'&#xe613;', title:'链上钱包',id:'50'}"><i class="layui-icon">&#xe613;</i><span> 链上钱包</span></a></dd>-->
                    <!--</dl>-->
                    <dl class="layui-nav-child">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/account/record',icon:'&#xe659;',title:'充币记录',id:'15'}">
                                <i class="layui-icon">&#xe659;</i>
                                <span> 充币记录</span>
                            </a>
                        </dd>
