...
<div class="layui-form-item">
    <label class="layui-form-label">邀请奖励(USDT)</label>
    <div class="layui-input-inline">
        <input type="number" name="invite_reward" autocomplete="off" class="layui-input"
            value="@if(isset($setting['invite_reward'])){{$setting['invite_reward'] ?? 0}}@endif"  οnkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onafterpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
    </div>
    <div class="layui-form-mid layui-word-aux"></div>
</div>