    ...
    <div class="layui-item">
        <div class="layui-inline" style="margin-left: 10px;">
            ...
            <div class="layui-input-inline" style="width: 90px">
                <select name="currency_id" id="from_name" class="layui-input">
        ...
        layui.use(['element', 'form', 'layer', 'table', 'laydate'], function() {
            ...
            var data_table =   table.render({
                ...
                cols: [[
                    ...
                    ,{field: 'user_id', title: '会员账号', width: 100}
                    ,{field: 'currency_id', title: '产出币种', width: 80, sort: true}
                    ,{field: 'name', title: '名称', width: 80,  sort: true}
                    // ,{field: 'chance', title: '权重', width: 80, sort: true, hide: false}
                    ,{field: 'num', title: '数量', width: 80, sort: true, hide: false,default:0}
