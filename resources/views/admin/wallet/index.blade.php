        ...
        var data_table = table.render({
            ...
            ,cols: [
                [
                    ...
                    ,{title: '交易币', width: 380, colspan: 2, rowspan: 1, align: "center"}
                    ...
                    {field: 'legal_balance', title: '余额', width: 130, totalRow: true, hide: true}
                    ,{field: 'lock_legal_balance', title: '冻结', width: 130, totalRow: true, hide: true}
                    ,{field: 'change_balance', title: '余额', width: 130, totalRow: true, hide: true}
                    ,{field: 'lock_change_balance', title: '冻结', width: 130, totalRow: true, hide: true}
                    ,{field: 'lever_balance', title: '余额', width: 130, totalRow: true, hide: true}
                    ,{field: 'lock_lever_balance', title: '冻结', width: 130, totalRow: true, hide: true} 
                ]
            ],
