...
<head>
	...
	<style>
		...
		*{padding: 0px;margin: 0px;}
		...
		.u_logo{
			background: url("{{URL("images/phone.png")}}") no-repeat;
			padding: 10px 10px;
			position: absolute;
			top: 43px;
			left: 40px;
		...
		.m_logo{
			background: url("{{URL("images/username.png")}}") no-repeat;
			padding: 10px 10px;
			position: absolute;
			top: 22px;
			left: 40px;
		...
		.p_logo{
			background: url("{{URL("images/password.png")}}") no-repeat;
			padding: 10px 10px;
			position: absolute;
			top: 12px;
			left: 40px;
		...
		.tou{
			background: url("{{URL("images/tou.png")}}") no-repeat;
			width: 97px;
			height: 92px;
			position: absolute;
			top: -87px;
		...
		.left_hand{
			background: url("{{URL("images/left_hand.png")}}") no-repeat;
			width: 32px;
			height: 37px;
			position: absolute;
			top: -38px;
		...
		.right_hand{
			background: url("{{URL("images/right_hand.png")}}") no-repeat;
			width: 32px;
			height: 37px;
			position: absolute;
			top: -38px;
		...
		.initial_left_hand{
			background: url("{{URL("images/hand.png")}}") no-repeat;
			width: 30px;
			height: 20px;
			position: absolute;
			top: -12px;
		...
		.left_handing{
			background: url("{{URL("images/left-handing.png")}}") no-repeat;
			width: 30px;
			height: 20px;
			position: absolute;
			top: -24px;
		...
		.right_handinging{
			background: url("{{URL("images/right_handing.png")}}") no-repeat;
			width: 30px;
			height: 20px;
			position: absolute;
			top: -21px;
	...
	$('.enterlogin').click(function () {
		...
		$.ajax({
			...
			success : function(result) {
				if (result.type == 'ok'){
					window.location.href="{{URL('/winadmin/index')}}";
				}else{
...
<div style="position: fixed;bottom: 0px;text-align: center;width: 100%;">
	Copyright ©2023 <a style="margin-left: 10px;color: #000000;text-decoration: underline" href="/">后台管理系统</a>
</div>
</body>
</html>