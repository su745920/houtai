...
<script>
    ...
    layui.use(['table','form','laydate'], function(){
        ...
        table.render({
            elem: '#demo'
            ,url: "{{url('admin/czRewardGroup/page')}}" //数据接口
            ,page: true //开启分页
            ,id:'mobileSearch'
            ,cols: [[ //表头
                {field: 'id', title: 'ID', width:80, sort: true}
                ,{field: 'reward_amount', title: '奖励数量', width:180}
                ,{field: 'reward_username', title: '奖励用户', width:180}
                ,{field: 'create_date', title: '奖励时间', width: 140}

                ,{field: 'deposit_amount', title: '下级充值金额', width:180}
                ,{field: 'deposit_username', title: '下级用户', width:180}
                ,{field: 'deposit_date', title: '下级充值时间', width:180}
