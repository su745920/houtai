...
@section('page-content')
    <div style="margin-top: 10px;width: 100%;margin-left: 10px;">
        <button class="layui-btn layui-btn-normal"  onclick="layer_show('添加机器人','{{url('admin/robot/add')}}')">添加地址</button>
...
@section('scripts')
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#demo'
                ,url: '{{url('admin/robot/list_data')}}' //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer_show('编辑机器人','{{url('admin/robot/add')}}?id='+data.id);
