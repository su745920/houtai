    ...
    <div style="margin-top: 10px;width: 100%;margin-left: 0px;">
        <div class="layui-tab">
            <ul class="layui-tab-title">
                ...
                <li><a href="/admin/account/recharge_v2_success">充币通过记录</a></li>
                <li  class="layui-this">充币失败记录</li>
    ...
    <script>
        layui.use(['table','form','laydate'], function(){
            ...
            var data_table = table.render({
                elem: '#data_table'
                ,url: '/admin/account/recharge_v2_fail/page'
                ,page: true
                ,cols: [[
