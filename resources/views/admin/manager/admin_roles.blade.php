...
@section('page-content')
    ...
    @if(strpos($authorityList,"1111")>0)
    <button class="layui-btn layui-btn-normal layui-btn-radius" id="add_admin" style="border-radius: 4px;">添加角色</button>
    @endif
