        ...
        window.onload = function() {
            ...
            layui.use(['element', 'form', 'layer', 'table', 'laydate'], function() {
                ...
                var data_table =   table.render({
                    elem: '#order_list',
                    url: "/admin/invite/reward_conf_list",
                    ...
                    cols: [[
                        ...
                        ,{field: 'ratio', title: '返佣', width: 130}
                        ,{field: 'min_amount', title: '最低充值数量', width: 130}
                        ,{field: 'max_amount', title: '最高充值数量', width: 130}


                        ,{field: 'created_at', title: '日期', width: 170, sort: true}
                ...
                table.on('tool(order_list)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                    ...
                    var tr = obj.tr;
                    if (layEvent === 'edit') { //编辑
                        layer_show('编辑交易', '/admin/invite/configEdit?id=' + data.id);
                    }
                });
