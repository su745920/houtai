...
<div class="layui-form">
    <div class="layui-item">
        ...
        <div class="layui-inline" style="margin-left: 10px;">
            ...
            @if(strpos($authorityList,"2603")>0)
        ...
        <div class="layui-btn-group">
            @if(strpos($authorityList,"2602")>0)
            ...
            @endif
                ...
                @if(strpos($authorityList,"2604")>0)
...
<script type="text/html" id="barDemo">
    @if(strpos($authorityList,"2601")>0)
...
<script type="text/html" id="pre_profit_result_name">
    ...
    @{{# } else if (d.pre_profit_result == 2) { }}
        <span style="color:#89deb3;">@{{d.pre_profit_result_name}}</span>
    @{{# } else if (d.pre_profit_result == 3) { }}
        <span style="color:#89deb3;">@{{d.pre_profit_result_name}}</span>
    @{{# } else { }}
...
<script type="text/html" id="fact_profits">
    ...
    @{{# if (d.profit_result == 1) { }}
        <span style="color: #1aab65; font-weight: bolder;">+@{{Number(d.fact_profits).toFixed(8)}}</span>
    @{{# } else { }}
        <span  style="color:#FF0000; font-weight: bolder;">-@{{Number(d.fact_profits).toFixed(8)}}</span>
    @{{# } }}
    </div>
</script>
        ...
        layui.use(['element', 'form', 'layer', 'table', 'laydate'], function() {
            ...
            var data_table =   table.render({
                ...
                cols: [[
                    ...
                    ,{field: 'number', title: '数量', width: 90, templet: '<div><div style="text-align: right;">@{{Number.parseInt(d.u)}}</div></div>', totalRow: true}
