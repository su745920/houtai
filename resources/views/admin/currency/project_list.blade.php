        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto" lay-filter="layadmin-userfront-formlist">
                <div class="layui-form-item">
                    ...
                    <!--    </button>-->
                    <!--</div>-->
                    @if(strpos($authorityList,"3201")>0)
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{ title: '状态',templet:function(d){
                     ...
                     ,{title:'操作',minWidth:250,toolbar: '#barDemo'}
                ]]
            });
            //监听提交
            ...
            table.on('tool(boss)', function(obj){
                ...
                if(obj.event === 'del'){
                    layer.confirm('您确认删除吗', function (index) {
                        ...
                        $.ajax({
                            url: "/admin/currency/project/del",
                            type: "POST",
                            data: {"id": data.id},
                            dataType: "json",
