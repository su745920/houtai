    ...
    <div class="layui-form">
        <div class="layui-collapse">
                ...
                <div class="layui-colla-content layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-input-inline">
                                <select name="plate_id" lay-verify="required">
                                    @foreach ($plates as $key => $plate)
                                        <option value="{{ $plate->id }}" @if ((isset($currency_match) && $currency_match->plate_id == $plate->id)) selected @endif>{{ $plate->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">排序</label>
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" class="layui-input" name="sort" placeholder="排序" value="{{ $currency_match->sort ?? 0 }}" >
                            </div>
                            <div class="layui-form-mid">数值越小越靠前,支持负数</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">交易功能</label>
                        <div class="layui-input-block">
                            <input type="checkbox" name="open_transaction" value="1" title="币币交易" @if (isset($currency_match)) {{ $currency_match->open_transaction == 1 ? 'checked' : '' }} @else checked @endif>
                            <input type="checkbox" name="open_lever" value="1" title="合约交易" @if (isset($currency_match)) {{ $currency_match->open_lever == 1 ? 'checked' : '' }} @else checked @endif>
                            <input type="checkbox" name="open_micro" value="1" title="秒合约交易" @if (isset($currency_match)) {{ $currency_match->open_micro == 1 ? 'checked' : '' }} @else checked @endif>
                        </div>
                    </div>
                </div>
            </div>
            <div class="layui-colla-item">
                <h2 class="layui-colla-title">撮合交易参数</h2>
                <div class="layui-colla-content layui-show">
                    <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">手续费</label>
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" class="layui-input" name="exchange_rate" placeholder="撮合交易手费续" value="{{ $currency_match->exchange_rate ?? 0.00 }}" >
                            </div>
            ...
            <div class="layui-colla-item">
             ...
             <div class="layui-colla-item">
                <h2 class="layui-colla-title">秒合约交易参数</h2>
                <div class="layui-colla-content layui-show">
                    <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">最小波动</label>
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" class="layui-input" name="fluctuate_min" placeholder="最小波动" value="{{ $currency_match->fluctuate_min ?? 0.00 }}" >
                            </div>
                            <div class="layui-form-mid">%</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="currency_id" class="layui-form-label">最大波动</label>
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" class="layui-input" name="fluctuate_max" placeholder="最大波动" value="{{ $currency_match->fluctuate_max ?? 0.00 }}" >
                            </div>
                            <div class="layui-form-mid">%</div>
                        </div>
                    </div>
