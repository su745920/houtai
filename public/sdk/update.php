...
$body = json_decode($responseBody)->body;
 //echo "\n";
$jsonPO= json_encode($client->checkResponse($body));
//echo $jsonPO;

$outTradeNo = json_decode($jsonPO)->outTradeNo;


//echo $outTradeNo;

$con=mysqli_connect("localhost","root","61663880b899674f","jys_php");
// 检测连接
if (mysqli_connect_errno())
{
    echo "连接失败: " . mysqli_connect_error();
}
mysqli_query($con,"UPDATE recharge_record SET status=1 WHERE order_no='".$outTradeNo."'");
mysqli_close($con);
