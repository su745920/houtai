  ...
  var setIframe = function(editor, textArea, set){
    ...
    iframe.css({
      ...
      ,style = $(['<style>'
        ...
        ,'pre{margin: 10px 0; padding: 10px; line-height: 20px; border: 1px solid #ddd; border-left-width: 6px; background-color: #ffffff; color: #333; font-family: Courier New; font-size: 12px;}'
      ,'</style>'].join(''))
