...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'admin_logger' => \App\Http\Middleware\AdminLogger::class,
        ...
        'lang_check' => \App\Http\Middleware\LangCheck::class,
        'cross' => \App\Http\Middleware\Cross::class,
        'check_pay_password' => \App\Http\Middleware\CheckPayPassword::class,
        'lever_hold_check' => \App\Http\Middleware\HoldCheck::class,
        'demo_limit' => \App\Http\Middleware\DemoLimit::class,
        'validate_user_locked' => \App\Http\Middleware\ValidateUserLocked::class,
        'valid_chain_push' => \App\Http\Middleware\ValidChainPush::class,
