...
use App\Models\{Currency, Users, UsersWallet};

class WalletController extends Controller
{
    public function index()
    {
        $currencies = Currency::where('multi_protocol', 0)->get();
    ...
    public function updateBalance(Request $request)
    {
        ...
        //更改为队列方式更新
        UpdateBalance::dispatch($wallet)->onQueue('update:block:balance:first'); // 队列任务按优先级处理
