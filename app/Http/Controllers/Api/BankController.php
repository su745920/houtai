...
use App\Models\LhBankAccountLog;
use App\Models\LhBankTeamMember;
use App\Models\LhDepositOrder;
use App\Models\LhDepositOrderLog;
use App\Models\LhLoanOrder;
    ...
    public function saveMoney(){
        ...
        try{
            ...
            $result = change_wallet_balance(
                ...
                '转账入余币宝',
                'Transfer to balance currency treasure',
                false,
                0,
                0,
                serialize([])
            ...
            case 1:
                ...
                try{
                    ...
                    change_wallet_balance(
                        ...
                        AccountLog::BANK_WITHDRAW,
                        '理财账户提现',
                        'Withdrawal from Wealth Management Account',
                        false,
                        0,
                        0,
                        serialize([])
