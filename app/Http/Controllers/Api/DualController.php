...
use App\Models\DualCurrency;
use App\Models\DualOrder;
...
class DualController  extends Controller
{
    ...
    public function index(Request $request){
        ...
        $dual_currencys = DualCurrency::where('currency_id',$currency_id)->orderBy('id','desc')->get();
    ...
    public function buyDual(Request $request){
        ...
        $buy_currency  = $dual_currencys->currency_id;
        ...
        try{
            ...
            change_wallet_balance($user_walllet , 2 , -$total , AccountLog::USER_DUAL_ORDER_BUY,'双币理财减少' . $user_walllet->name,'Dual currency wealth management reduces ' . $user_walllet->name);
            DB::commit();
