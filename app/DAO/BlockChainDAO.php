                ...
                if ($comp_result > 0) {
                    ...
                    if ($wallet->currencyCoin->parent_id != 0) {
                        ...
                        change_wallet_balance(
                            ...
                            "{$parent_wallet->currencyCoin->name}/{$wallet->currencyCoin->type} Coin charging on the chain increased"
                        );
                    } else {
                        change_wallet_balance(
                            $wallet,
                            ...
                            "{$wallet->currencyCoin->type} Coin charging on the chain increased"
                        );
                    }
