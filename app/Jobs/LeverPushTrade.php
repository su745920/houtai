...
use App\Models\{Currency, LeverTransaction, UsersWallet};
    ...
    public function handle()
    {
        try {
            ...
            $push_data = [
                ...
                'legal_name' => Currency::findOrFail($this->legal_id)->name ?? '',
                'currency_id' => $this->currency_id,
                'currency_name' => Currency::findOrFail($this->currency_id)->name ?? '',
            ...
            //echo '推送订单数据:' . $this->user_id . PHP_EOL;
            SendMarket::dispatch($push_data)->onQueue('lever:send:trade');
