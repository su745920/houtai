    ...
    protected function generateFollowOrder($order, $follow)
    {
        try {
            ...
            if (bc_comp($user_lever, $shoud_deduct) < 0) {
                throw new \Exception($currency_match->legal_name . trans('microorder.zdxdslbcgc') . $shoud_deduct . trans('microorder.zdxdslbcdd')  . $trade_fee . ')');
            }
            ...
            $result = change_wallet_balance(
                ...
                'Follow the purchase ' . $currency_match->symbol . ' leveraged trading, price ' . $order['price'] . ',Deducting the deposit',
                false,
                0,
                0,
                serialize([
            ...
            $result = change_wallet_balance(
                ...
                'Follow the purchase ' . $currency_match->symbol . ' leveraged trading, deducting transaction fees',
                false,
                0,
                0,
                serialize([
