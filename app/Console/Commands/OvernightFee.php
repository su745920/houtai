                    ...
                    foreach ($lever_transactions as $key => $trade) {
                        ...
                        DB::transaction(function() use ($trade) {
                            ...
                            $result = change_wallet_balance(
                                ...
                                'leverage trading id:' . $trade->id. ',Collect overnight fees:' . $overnight_fee . '(Deduction from margin:' . $caution_should_deduct . ',Deduct from balance:' . $balance_should_deduct . ')',
                                false,
                                0,
                                0,
                                $extra_data,
